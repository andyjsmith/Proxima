...
report(
    ...
    "\n".join(f"{n}-{v}" for n, v in spice_ns)
    or "none -- install gir1.2-spiceclientgtk-3.0 / mingw-w64-*-spice-gtk",
)
...
if session_cls and display_cls:
    try:
        ...
        try:
            ...
            report(
                is_widget,
                "SpiceDisplay constructs as a GtkWidget",
...
print(
    ...
    + (
        ...
        if ok
        else "SOMETHING FAILED - see the [FAIL] lines above."
    )
)
